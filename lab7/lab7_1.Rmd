...
```{r}
summary(msleep24)
#looking at sleep total column, checking the mins and maxs to make sure they fall within the ranges that were specified
```
...
msleep %>% 
  ...
  summarise(mean_sleep_lg = mean(sleep_total),
            ...
            total = n())
          #total tells us the number of rows. 7 animals that have a bodyweight of >200
#sd is standard deviation
#could store it as new variable but do not need to do it everytime unless we're going to be using it again in the future
```
...
msleep %>% 
  ...
  summarise(mean_bodywt = mean(bodywt),
            ...
            total = n())
#command and return runs the highlighted line
...
NA is the NA found in the brian weight so they arent 
```{r}
msleep %>% 
