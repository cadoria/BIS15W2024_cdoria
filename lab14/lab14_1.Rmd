...
```{r}
#type shiny app plus shift and tab 
```
...
) #refers to drop down menu = select Input, selected is where its going to start. 
...
ui <- fluidPage(
    ...
    plotOutput("plot", width="500px", height="400px") #providing the size/aspect of the visual thats being produced
)
