...
```{r}
## %>%  is the pipe (shift command m)
fish %>%
  select(lakeid, scalelength) %>% #another pipe to output the function and filter out our observations interest
  filter(lakeid == "AL")
# takes the fish data, select the variable and take the output of that and filter the AL
```
