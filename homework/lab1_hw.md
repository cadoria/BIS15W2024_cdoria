...
The difference between R and RStudio is that R is the scripting language which is a program. RStudio is a GUI which is a graphical user interface which allows for easier visualization. 
